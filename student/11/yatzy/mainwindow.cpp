...
MainWindow::MainWindow(YatzyGame* game, QWidget *parent): QWidget(parent),
    ...
    twoPairScoreLabel_(this),
    scoreTwoPairButton_("Score Two Pairs", this),
    ...
    quitButton_("Quit", this)
{
    ...
    connect(&scoreTwoPairButton_, SIGNAL(clicked(bool)), this, SLOT(scoreTwoPairs()));
...
void MainWindow::scoreTwoPairs()
{
    ...
    twoPairScoreLabel_.setText(QString::number(score));
...
void MainWindow::reset()
{
    ...
    twoPairScoreLabel_.clear();
    yatzyScoreLabel_.clear();
    smallStraightScoreLabel_.clear();
...
void MainWindow::updateControls()
{
    ...
    scoreTwoPairButton_.setEnabled(game_->canScore(YatzyRules::TWO_PAIRS));
...
void MainWindow::setupLayout()
{
    ...
    twoPairScoreLabel_.setObjectName("twoPairsScoreLabel");

    scoreTwoPairButton_.setObjectName("scoreTwoPairsButton");
    ...
    scoreLayout->addWidget(new QLabel("Two pair:", this), 2, 0, 1, 1);
    scoreLayout->addWidget(&twoPairScoreLabel_, 2, 1, 1, 1);
    scoreLayout->addWidget(&scoreTwoPairButton_, 2, 2, 1, 1);

    scoreLayout->addWidget(new QLabel("Yatzy:", this), 3, 0, 1, 1);
    scoreLayout->addWidget(&yatzyScoreLabel_, 3, 1, 1, 1);
    scoreLayout->addWidget(&scoreYatzyButton_, 3, 2, 1, 1);

    scoreLayout->addWidget(new QLabel("Small straight:", this), 4, 0, 1, 1);
    scoreLayout->addWidget(&smallStraightScoreLabel_, 4, 1, 1, 1);
    scoreLayout->addWidget(&scoreSmallStraightButton_, 4, 2, 1, 1);
